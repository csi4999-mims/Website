...
<div class="report form">
    ...
    <fieldset>
        ...
        echo $this->Form->input('missing_weight_pounds', array('label' => 'Weight (lbs)', 'maxLength' => 20, 'title' => 'weight', 'type' => 'number'));
        echo $this->Form->input('missing_height_inches', array('label' => 'Height (in)', 'maxLength' => 20, 'title' => 'Inches', 'type' => 'number'));
        echo $this->Form->input('missing_height_feet', array('label' => 'Height (ft)', 'maxLength' => 1, 'title' => 'Feet', 'type' => 'number'));
    ...
    <fieldset>
        ...
        echo $this->Form->input('ff_alias', array('label' => 'Relation to Missing', 'options' => array('-' => '-', 'Mother' => 'Mother', 'Father' => 'Father', 'Daughter' => 'Daughter', 'Son' => 'Son', 'Sister' => 'Sister',
         'Brother' => 'Brother', 'Aunt' => 'Aunt', 'Uncle' => 'Uncle', 'Niece' => 'Niece', 'Nephew' => 'Nephew', 'Cousin' => 'Cousin', 'Friend' => 'Friend', 'Other' => 'Other' )));
        echo $this->Form->input('ff_alias_other', array('label' => 'Relation Other', 'maxLength' => 256, 'title' => 'Relation Other', 'type' => 'text'));
    ...
    <fieldset>
        ...
        <?php
        echo $this->Form->input('hangout_name', array('label' => 'Hangout Name', 'maxLength' => 30, 'title' => 'Hangout Name', 'type' => 'text'));
        echo $this->Form->input('hangout_street', array('label' => 'Street Name', 'maxLength' => 20, 'title' => 'Street', 'type' => 'text'));
        echo $this->Form->input('hangout_number', array('label' => 'Address Number', 'maxLength' => 10, 'title' => 'address', 'type' => 'text'));
        echo $this->Form->input('hangout_city', array('label' => 'City', 'maxLength' => 20, 'title' => 'City', 'type' => 'text'));
        echo $this->Form->input('hangout_state', array('label' => 'State', 'maxLength' => 2, 'title' => 'State', 'type' => 'text'));
        echo $this->Form->input('hangout_zip', array('label' => 'Zip', 'maxLength' => 5, 'title' => 'Zip', 'type' => 'text'));
        echo $this->Form->input('hangout_misc', array('label' => 'Additional Information', 'maxLength' => 2000, 'title' => 'SocialMedia', 'type' => 'textarea'));
        ?>
    </fieldset>
    ...
    <fieldset>
        ...
        echo $this->Form->input('workplace_misc', array('label' => 'Additional Information', 'maxLength' => 2000, 'title' => 'SocialMedia', 'type' => 'textarea'));
