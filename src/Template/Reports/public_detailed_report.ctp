                ...
                <legend><?php echo __('Missing Person Information'); ?></legend>
                  ...
                  <div id="display-missing" class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editFirstName', array('value' => $report->get('FirstName'), 'label'
                           => 'First Name', 'maxLength' => 50,'title' => 'FirstName', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editMiddleName', array('value' => $report->get('MiddleName'),'label'
                           => 'Middle Name', 'maxLength' => 50, 'title' => 'MiddleName', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editLastName', array('value' => $report->get('LastName'),'label'
                           => 'Last Name', 'maxLength' => 50, 'title' => 'LastName', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editAlias', array('value' => $report->get('Alias'),'label' => 'Alias',
                        'maxLength' => 100, 'title' => 'Alias', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editSubmitterEmail', array('value' => $report->get('SubmitterEmail'),'label'
                         => 'Email Address', 'maxLength' => 100, 'title' => 'Email', 'type' => 'email', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editPhone', array('value' => $report->get('Phone'),'label'
                         => 'Phone', 'placeholder' => '(XXX)XXX-XXXX', 'maxLength' => 10, 'title' => 'Phone', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editGender', array('value' => $report->get('Gender'), 'readonly' => 'readonly','label' =>
                          'Gender', 'options' => array('-' => '-', 'Male' => 'Male','Female' =>'Female','androgynous' => 'Androgynous'))); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editEthnicity', array('value' => $report->get('Ethnicity'),'id' => 'ME', 'onchange' => 'meOther(this)', 'readonly' => 'readonly','label'
                        ...
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editMissingEthnicityOther', array('value' => $report->get('MissingEthnicityOther'),'id' => 'MEO', 'readonly' => 'readonly', 'label'
                          => 'Ethnicity Other', 'maxLength' => 255, 'title' => 'EthinicityOther', 'type' => 'text')); ?>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editEyeColor', array('value' => $report->get('EyeColor'), 'readonly' => 'readonly','id' => 'MEC',
                      ...
                      <div class="col-md-4">
                        ...
                        => 'Eye Color Other', 'maxLength' => 255, 'title' => 'EyeColorOther', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editHairColor', array('value' => $report->get('HairColor'), 'readonly' => 'readonly','id' => 'MHC', 'onchange' => 'mhcOther(this)', 'options'
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          ...
                          => 'Marks/Tattoos', 'maxLength' => 256, 'title' => 'marks', 'type' => 'textarea', 'readonly' => 'readonly')); ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editWeight', array('value' => $report->get('Weight'),'label'
                         => 'Weight (lbs)', 'maxLength' => 20, 'title' => 'weight', 'type' => 'number', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editHeightFeet', array('value' => $report->get('HeightFeet'),'label'
                         => 'Height (ft)', 'maxLength' => 1, 'title' => 'Feet', 'type' => 'number', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editHeightInches', array('value' => $report->get('HeightInches'),'label'
                         => 'Height (in)', 'maxLength' => 20, 'title' => 'Inches', 'type' => 'number', 'readonly' => 'readonly')); ?>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('edit_missing_facebook_username', array('value' => $report->get('missing_facebook_username'),'label'
                           => 'Facebook Account Name', 'maxLength' => 50, 'title' => 'SocialMedia', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                        <div class="col-md-4">
                          <?php echo $this->Form->input('edit_missing_twitter_username', array('value' => $report->get('missing_twitter_username'),'label'
                           => 'Twitter Account', 'maxLength' => 50, 'title' => 'SocialMedia', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('edit_missing_snapchat_username', array('value' => $report->get('missing_snapchat_username'),'label'
                         => 'Snapchat Account', 'maxLength' => 50, 'title' => 'SocialMedia', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('edit_missing_instagram_username', array('value' => $report->get('missing_instagram_username'),'label'
                         => 'Instagram Account', 'maxLength' => 50, 'title' => 'SocialMedia', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editReportMiscInfo', array('value' => $report->get('ReportMiscInfo'),'label' =>
                        'Additional Information', 'maxLength' => 2000, 'title' => 'SocialMedia', 'type' => 'textarea', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    ...
                    <!-- <div class="row">
                        <div class="col-md-6">
                          ...
                          'placeholder' => 'mm/dd/yyyy', 'maxLength' => 10, 'title' => 'Date', 'type' => 'datetime', 'readonly' => 'readonly')); ?>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editSeenNotes', array('value' => $report->get('SeenNotes'),'label' => 'Additional Information',
                         'maxLength' => 2000, 'title' => 'Description', 'type' => 'textarea', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyFirstName', array('value' => $report->get('FamilyFirstName'),'label' => 'First Name',
                         'maxLength' => 256, 'title' => 'FirstName', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyMiddleName', array('value' => $report->get('FamilyMiddleName'),'label' => 'Middle Name',
                        'maxLength' => 256, 'title' => 'LastName', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyPhone', array('value' => $report->get('FamilyPhone'),'label' => 'Phone',
                         'placeholder' => '(XXX)XXX-XXXX', 'maxLength' => 10, 'title' => 'Phone', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyEmail', array('value' => $report->get('FamilyEmail'),'label' => 'Email',
                         'maxLength' => 256, 'title' => 'Email', 'type' => 'email', 'readonly' => 'readonly')); ?>
                      </div>

                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editFamilyGender', array('value' => $report->get('FamilyGender'), 'readonly' => 'readonly','label' => 'Gender',
                          'options' => array('-' => '-', 'Male' => 'Male','Female' =>'Female'))); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editFamilyEthnicity', array('value' => $report->get('FamilyEthnicity'), 'readonly' => 'readonly', 'id' => 'FFE', 'onchange' => 'ffeOther(this)','label' => 'Ethnicity','options' =>
                        ...
                        <div class="col-md-4">
                          ...
                          'Ethnicity Other', 'maxLength' => 255, 'title' => 'EthinicityOther', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <?php echo $this->Form->input('editRelation', array('value' => $report->get('Relation'), 'readonly' => 'readonly','id' => 'FFA', 'onchange' => 'ffaOther(this)','label' => 'Relation to Missing', 'options' =>
                        ...
                        <div class="col-md-4">
                          ...
                          'Relation Other', 'maxLength' => 256, 'title' => 'Relation Other', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyStreet', array('value' => $report->get('FamilyStreet'),'label' => 'Street',
                         'maxLength' => 256, 'title' => 'street', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editFamilyCity', array('value' => $report->get('FamilyCity'),'label' => 'City',
                        'maxLength' => 256, 'title' => 'city', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  <legend><?php echo __('Missing Person Hangouts'); ?></legend>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editHangoutMisc', array('value' => $report->get('HangoutMisc'), 'readonly' => 'readonly','label' =>
                  ...
                  <legend><?php echo __('Missing Person Workplace'); ?></legend>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          ...
                          'maxLength' => 30, 'title' => 'Workplace Name', 'type' => 'text', 'readonly' => 'readonly')); ?>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editWorkplaceZip', array('value' => $report->get('WorkplaceZip'),'label' => 'Zip', 'maxLength'
                         => 5, 'title' => 'Zip', 'type' => 'text', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
                    ...
                    <!-- <div class="row">
                        <div class="col-md-3">
                          ...
                          => 'Started working: ', 'placeholder' => 'mm/dd/yyyy', 'maxLength' => 10, 'title' => 'Date', 'type' => 'date', 'readonly' => 'readonly')); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                          <?php echo $this->Form->input('workplace_end_date', array('label'
                          => 'Stopped working: ', 'placeholder' => 'mm/dd/yyyy', 'maxLength' => 10, 'title' => 'Date', 'type' => 'date', 'readonly' => 'readonly')); ?>
                        </div>
                    </div> -->
                    <div class="row">
                      <div class="col-md-4">
                        <?php echo $this->Form->input('editWorkplaceMisc', array('value' => $report->get('WorkplaceMisc'),'label' => 'Additional Information',
                         'maxLength' => 2000, 'title' => 'SocialMedia', 'type' => 'textarea', 'readonly' => 'readonly')); ?>
                      </div>
                    </div>
              </div>
              </div>
